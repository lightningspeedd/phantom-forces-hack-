...
local Window = Library:CreateWindow({
    Title = 'lightningballs (made by @lightningspeeddd)',
    Center = true,
    AutoShow = true,
    TabPadding = 8,
    MenuFadeTime = 0.2
...
do --// Properties & Rest
    ...
    do --// Properties
        ...
        TextLabel.Text = "lightningballs | made by @lightningspeeddd enjoyer"
...
ThemeManager:SetFolder('Lightningballs')
SaveManager:SetFolder('Lightningballs/PhantomForces')
